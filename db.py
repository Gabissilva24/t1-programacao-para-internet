...
# esta conectando diretamente ao MySQL(pode usar codigo sql aqui diretamente)
def iniciar_bd():
    try:
        ...
        arquivo_sql = os.path.join(os.path.dirname(__file__), 'schema.sql') #busca onde esta a pasta e retorna esse arquivo
        with open(arquivo_sql, 'r', encoding='utf-8') as f:
            script_sql = f.read()

        # multi=True pega cada sql; e separa para execucao
